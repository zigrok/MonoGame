...
MG_EXPORT mgulong MGA_Voice_GetSamplesPlayed(MGA_Voice* voice);
MG_EXPORT mgulong MGA_GetLivePcmBufferBytes();
MG_EXPORT void MGA_Voice_GetPcmBufferMemory(MGA_Voice* voice, mgulong* allocatedBytes, mgulong* queuedBytes);
